...
import './FeedPhotoInteractions.scss';
import { FeedPhotoComments } from './FeedPhotoComments';

export function FeedPhotoInteractions({ comments }) {
  return (
    <div className="feed-photo-interactions">
      <section className="feed-photo-interactions__actions">
      ...
      <section className="feed-photo-interactions__likes">41 Me gusta</section>
      <FeedPhotoComments comments={comments} />
      <div className="feed-photo-interactions__date">Hace 2 días</div>
      <div className="feed-photo-interactions__new-comment">Añade un comentario...</div>
    </div>
  )
}